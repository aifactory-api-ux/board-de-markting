...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de AdminUsuarios >> botón Create en modal existe
- Location: frontend/tests-functional/buttons.spec.ts:46:3
