...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de BoardPrincipal >> botón Create en modal New Board existe
- Location: frontend/tests-functional/buttons.spec.ts:69:3
