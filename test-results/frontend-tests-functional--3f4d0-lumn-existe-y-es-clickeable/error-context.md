...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de BoardPrincipal >> botón + Add Column existe y es clickeable
- Location: frontend/tests-functional/buttons.spec.ts:62:3
