...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de BoardPrincipal >> botón + New Board existe y es clickeable
- Location: frontend/tests-functional/buttons.spec.ts:55:3
