...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de AdminUsuarios >> botón Cancel en modal existe y es clickeable
- Location: frontend/tests-functional/buttons.spec.ts:38:3
