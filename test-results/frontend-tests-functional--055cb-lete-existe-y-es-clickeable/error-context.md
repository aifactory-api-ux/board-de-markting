...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de DetalleTarjeta >> botón Delete existe y es clickeable
- Location: frontend/tests-functional/buttons.spec.ts:108:3
