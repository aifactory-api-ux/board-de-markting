...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de AdminUsuarios >> botón + Add User existe y es clickeable
- Location: frontend/tests-functional/buttons.spec.ts:19:3
