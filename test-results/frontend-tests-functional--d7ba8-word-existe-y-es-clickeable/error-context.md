...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de Configuracion >> botón Update Password existe y es clickeable
- Location: frontend/tests-functional/buttons.spec.ts:92:3
...
Call log:
  - navigating to "/configuracion", waiting until "load"
