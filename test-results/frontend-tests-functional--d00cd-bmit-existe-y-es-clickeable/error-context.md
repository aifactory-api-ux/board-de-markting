...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de Login >> botón submit existe y es clickeable
- Location: frontend/tests-functional/buttons.spec.ts:4:3
