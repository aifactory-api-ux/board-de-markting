...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de BoardPrincipal >> botón Cancel en modal New Board existe
- Location: frontend/tests-functional/buttons.spec.ts:76:3
