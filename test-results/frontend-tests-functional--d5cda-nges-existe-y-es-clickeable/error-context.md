...
- Name: frontend/tests-functional/buttons.spec.ts >> Botones de Configuracion >> botón Save Changes existe y es clickeable
- Location: frontend/tests-functional/buttons.spec.ts:85:3
